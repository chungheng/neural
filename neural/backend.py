...
try:
    ...
    NeuroDriverKernelGenerator = None
...
class Backend(object):
    def __new__(cls, model, **kwargs):
        ...
        if cls is Backend:
            ...
            elif backend == 'neurodriver':
                assert NeuroDriverKernelGenerator is not None, \
                    "Either NeuroKernel/NeuroDriver or PyCodegen is not installed."
                return super(Backend, cls).__new__(NeuroDriverBackend)
            else:
