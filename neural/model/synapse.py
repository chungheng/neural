...
class AMPA(Model):
    ...
    Default_States = dict(I=0.0, s=(0.0, 0.0, 1.0))
...
class NMDA(Model):
    ...
    Default_States = dict(x=(0.0, 0.0, 1.0), s=(0.0, 0.0, 1.0))
    Default_Params = dict(a1=5e1, b1=4.5e0, a2=1.8e1, b2=3.4e1, gmax=300.0)
...
class GABAB(Model):
    ...
    Default_States = dict(r=(0.0, 0.0, 1.0), s=(0.0, 0.0, 1.0))
    Default_Params = dict(ar=1e1, br=1e1, k3=1.8e1, k4=3.4e1, kd=0.4, gmax=200.0, n=4)
...
class Alpha(Model):
    ...
    Default_States = dict(s=0.0, u=0.0)
